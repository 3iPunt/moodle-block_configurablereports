...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading('block_configurable_reports/remotedatabasehdr',
        new lang_string('remotedatabase', 'block_configurable_reports'), ''));
    ...
    $settings->add(new admin_setting_heading('block_configurable_reports/sharedrepositorieshdr',
        new lang_string('sharedrepositories', 'block_configurable_reports'), ''));
    ...
    $settings->add(new admin_setting_heading('block_configurable_reports/userinterfacehdr',
        new lang_string('userinterface', 'block_configurable_reports'), ''));
